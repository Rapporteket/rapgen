...
# get data
df <- rapgen::RegDelayReport(years, registryKeyNames, registrationFormNames, peculiarity)
...
```
Table: Median dager fra hendelse til registrering per `r as.character(format(Sys.Date(), format="%e. %B %Y"))`
