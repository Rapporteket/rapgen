...
```
Table: Andel (og antall) av årene, månedene, ukene og dagene med minimum ett opprettet skjema målt i perioden fra `r as.character(format(as.Date(startDate), format="%e. %B %Y"))` til `r as.character(format(as.Date(endDate), format="%e. %B %Y"))`.
